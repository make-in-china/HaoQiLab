...
let Pagination = class Pagination extends __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].Component {
    showTotal(total) {
        return `Total ${total} items`;
    }
    itemRender(page, type) {
        if (type === 'prev') {
            return __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement("a", null, "\u4E0A\u4E00\u9875");
        }
        else if (type === 'next') {
            return __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement("a", null, "\u4E0B\u4E00\u9875");
        }
        return null;
    }
    render() {
        return [
            __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_more__["a" /* default */].Pagination, { key: "1", simple: undefined, defaultCurrent: 2, total: 50 }),
            __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_more__["a" /* default */].Pagination, { key: "2", size: "small", total: 50 }),
            __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_more__["a" /* default */].Pagination, { key: "3", size: "small", total: 50, showSizeChanger: undefined, showQuickJumper: undefined }),
            __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_more__["a" /* default */].Pagination, { key: "4", size: "small", total: 50, showTotal: this.showTotal }),
            __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_more__["a" /* default */].Pagination, { key: "5", total: 500, itemRender: this.itemRender })
        ];
    }
};
