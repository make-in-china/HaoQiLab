...
let Spin = class Spin extends __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].Component {
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_min__["b" /* default */].Spin, { size: "large", indicator: __WEBPACK_IMPORTED_MODULE_0_react_ex__["a" /* default */].createElement(__WEBPACK_IMPORTED_MODULE_1_antd_min__["b" /* default */].Icon, { type: "loading", style: { fontSize: 24 }, spin: undefined }), tip: "读取皮肤..." }));
    }
};
Spin = __decorate([
