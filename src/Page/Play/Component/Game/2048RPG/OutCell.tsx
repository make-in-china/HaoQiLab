...
const { config, clsMap } = eClassConfig({
    cellBox: css`vertical-align:top;margin-left:-2px;margin-top:-2px;padding:2px;border:2px solid #dde;width:38px;height:38px;line-height:1;box-sizing:border-box;display:inline-block;`
});
@React.eclass(config)
@observer
