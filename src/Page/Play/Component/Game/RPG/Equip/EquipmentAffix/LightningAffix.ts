...
export class LightningAffix extends EquipmentAffix {
    priority = 0;
    ...
    effectDesction() {
        return makeBlueEffecctDesction(`角色闪电伤害增加(${this.persent})%`);
    }
    effectCreatures(creatures: Creatures): void {
        creatures.computed.lightningDamageMore += this.persent;
    }
}